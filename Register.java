    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource()==registerButton)
        {
            try {
                ...
                Connection connection=DriverManager.getConnection("jdbc:mysql://localhost:3306/projectforclass","root","anjusha123");
                //Preapared Statement
                PreparedStatement Pstatement=connection.prepareStatement("insert into patients_table values(?,?,?,?,?,?,?)");
